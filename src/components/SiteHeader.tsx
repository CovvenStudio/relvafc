    ...
    <header className="sticky top-0 z-40 border-b border-white/5 bg-background/70 backdrop-blur-xl">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 h-16 flex items-center gap-6">
        <Link to="/" className="flex items-center gap-2" onClick={() => setOpen(false)}>
          <div className="h-8 w-8 rounded-md bg-gold-gradient flex items-center justify-center text-background font-black text-lg">P</div>
          <span className="text-display text-xl tracking-tight"><span className="text-white">ProFoot</span><span className="text-gold">Play</span></span>
        </Link>
    ...
    <footer className="border-t border-white/5 bg-background/80 mt-20">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 py-12 grid gap-8 md:grid-cols-4">
        <div className="md:col-span-2">
          <div className="flex items-center gap-2">
            <div className="h-8 w-8 rounded-md bg-gold-gradient flex items-center justify-center text-background font-black text-lg">P</div>
            <span className="text-display text-xl"><span className="text-white">ProFoot</span><span className="text-gold">Play</span></span>
          </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-white/70">
            ...
            <li><Link to="/comparar" className="hover:text-gold">Comparar</Link></li>
        ...
        <div>
          <div className="text-display text-gold text-sm mb-3">ProFootPlay</div>
          <ul className="space-y-2 text-sm text-white/70">
      ...
      <div className="border-t border-white/5">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-4 text-xs text-muted-foreground flex flex-wrap items-center justify-between gap-2">
          <span>© {new Date().getFullYear()} ProFootPlay — Lisboa, Portugal</span>
